...
mkdir -p /opt/.cache/crows-nest
mkdir -p /opt/.cache/bowsprit
mkdir -p /opt/.cache/hull
mkdir -p /opt/.cache/bow/shark-infested-waters
mkdir -p /opt/.cache/yardarm
mkdir -p /opt/.cache/poop-deck
mkdir -p /opt/.cache/stern
mkdir -p /opt/.cache/helm
mkdir -p /opt/.cache/ratlines
mkdir -p /opt/.cache/hold
mkdir -p /opt/.cache/forecastle/bunk
mkdir -p /opt/.cache/forecastle/secret-compartment

cat <<EOF >"/opt/.cache/crows-nest/shinny-object"
...
cat <<EOF >"/opt/.cache/crows-nest/stern/adventure-gallery"
...
cat <<EOF >"/opt/.cache/forecastle/secret-compartment/treasure-map-4"
