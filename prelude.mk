...
CONTAINER_NAME := $(DOCKER_REGISTRY_FQDN)/$(CONTAINER_BASE_NAME):$(CONTAINER_TAG)
...
CONTAINER_NAME_LATEST := $(DOCKER_REGISTRY_FQDN)/$(CONTAINER_BASE_NAME):$(CONTAINER_TAG_LATEST)
