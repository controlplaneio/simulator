...
var stat_result = $B.make_class("stat_result",
  function (filename) {
    ...
    if ($B.files && $B.files.hasOwnProperty(filename)) {
      ...
      ["atime", "mtime", "ctime"].forEach(function (item) {
      ...
      ["mtime", "ctime", "atime_ns", "mtime_ns", "ctime_ns"].forEach(function (item) {
...
["WEXITSTATUS", "WSTOPSIG", "WTERMSIG"].forEach(function (funcname) {
  $module[funcname] = function () {
    return _b_.None
  }
});
