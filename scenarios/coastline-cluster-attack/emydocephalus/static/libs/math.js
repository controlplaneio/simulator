var $module = (function ($B) {
  ...
  var isWholeNumber = function (x) {
    return (x * 10) % 10 == 0
  }

  var isOdd = function (x) {
    return isWholeNumber(x) && 2 * Math.floor(x / 2) != x
  }

  var isNegZero = function (x) {
  ...
  */
  ...
  function atan(x) {
    ...
    if (_b_.float.$funcs.isninf(x)) {
      return _b_.float.$factory(-Math.PI / 2)
    }
    if (_b_.float.$funcs.isinf(x)) {
      return _b_.float.$factory(Math.PI / 2)
    }
  ...
  function cosh(x) {
    ...
    if (Math.cosh !== undefined) {
      return _b_.float.$factory(Math.cosh(y))
    }
...
// by Jacob Zhong
  ...
  function tanh(x) {
    ...
    if (Math.tanh !== undefined) {
      return _b_.float.$factory(Math.tanh(y))
    }
