...
func Test_TfVars_String(t *testing.T) {
	...
	expected := `access_cidr = ["10.0.0.1/16", "10.0.0.1/16"]
...
func Test_Ensure_TfVarsFile_with_settings(t *testing.T) {
	...
	require.NoError(t, err)
	expected := `access_cidr = ["10.0.0.1/16", "10.0.0.1/16", "10.0.0.1/32"]
access_github_usernames = []
access_key = "ssh-rsa"
attack_container_repo = "controlplane/simulator-attack"
attack_container_tag = "latest"
...
func Test_TfVars_IPDetection_Disabled(t *testing.T) {
	t.Parallel()
	tfv := simulator.NewTfVars("ssh-rsa", "", "test-bucket",
		"latest", "controlplane/simulator-attack", "", "")
	expected := `access_cidr = []
access_github_usernames = []
access_key = "ssh-rsa"
attack_container_repo = "controlplane/simulator-attack"
attack_container_tag = "latest"
